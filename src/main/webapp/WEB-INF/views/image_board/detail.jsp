				...
				<div class="offset-lg-2 col-lg-8">
					<div class="card">
						<div class="card-header text-white"
							style="background-color: #52b1ff;">${ board.boardNo }번게시물
							내용</div>
						<div class="card-body">
							...
							<div class="form-group" align="center">
								...
								<img width="100%"
									src="${ board.files.get(0).filePath }/${ board.files.get(0).changeName }" />
							</div>

							<c:forEach begin="1" end="${ board.files.size() - 1 }" var="i">
								<div class="form-group" align="center">
									<label style="color: #52b1ff;">상세 이미지-1번</label> <img
										width="100%" src="${board.files.get(i).filePath}/${board.files.get(i).changeName}"/>
								</div>
							</c:forEach>
							<a class="btn" href="http://localhost:8088/kh/boards.im"
